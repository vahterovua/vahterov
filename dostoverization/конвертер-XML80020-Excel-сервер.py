...
fig_day = px.line(df_pivot,x=df_pivot.index,y=[df_pivot.columns], title='линейные графики потребления электроэнергии в кВт*ч')
# Добавляем подписи данных над каждым столбцом
#fig.update_traces(texttemplate='%{y}', textposition='outside')
fig_day
...
df_pivot.to_excel(F'{UPLOAD_DIR}\общая таблица.xlsx')
