...
st.set_page_config(page_title="Инструменты аналитика", page_icon="📈")
st.title("📈 Инструменты аналитика")
...
if st.session_state.logged_in:
    ...
    pg = st.navigation({
        " ": [file_processing, show_graph, file_processing_1tu, file_show,new_processing,new_graf,xml80020_excel,sql,u10min]
    })
